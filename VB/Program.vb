    ...
    Friend Class Program
        ...
        Shared Sub Main(ByVal args As String())
            ...
            Using session As Session = New Session()
                ...
                obj.Save()
                Console.WriteLine("ID:" & Microsoft.VisualBasic.Constants.vbTab & "{0}, Name:" & Microsoft.VisualBasic.Constants.vbTab & "{1}", obj.GetMemberValue("ID"), obj.GetMemberValue("Name"))
            End Using

            Console.WriteLine("----------------------------")
            Using session As Session = New Session()
                Dim collection As XPCollection = New XPCollection(session, myClassA)
